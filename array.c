...
static CELL *         itable_find( ITable * it, STRING * sval, int64_t ival, int flag, size_t * sizep );
...
CELL *
array_find( ARRAY A, CELL * cp, int create_flag )
{
...
#ifdef QSORT
static int
i_compare( const void * l, const void * r )
{
    const int64_t * il = l;
    const int64_t * ir = r;
    return *il - *ir;
...
static int
s_compare( const void * l, const void * r )
{
    STRING * const * sl = l;
    STRING * const * sr = r;
...
CELL *
itable_find( ITable * htable, STRING * sval, int64_t ival, int flag, size_t * szp )
{
...
static void
itable_convert_i_to_s( ITable * ht )
{
    char     buffer[256];
...
static void
double_num_buckets( ITable * htable )
{
